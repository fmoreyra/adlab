...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Fecha hasta la cual este precio es válido",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "year",
                    models.IntegerField(
                        help_text="Año para el contador",
                        unique=True,
                        verbose_name="año",
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Último número de orden de trabajo asignado",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Número único de orden de trabajo (ej: OT-2024-001)",
                        max_length=50,
                        unique=True,
                ...
                (
                    ...
                    models.DateField(
                        ...
                        help_text="Fecha de emisión de la orden de trabajo",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Pago adelantado recibido",
                        max_digits=10,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Nombre para facturación (si difiere del veterinario)",
                        max_length=200,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="CUIT o CUIL del cliente",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Ruta del archivo PDF de la orden",
                        max_length=500,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Fecha en que se envió la orden a finanzas",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_type",
                    models.CharField(
                        help_text="Tipo de servicio prestado",
                        max_length=100,
                        verbose_name="tipo de servicio",
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["service_type"], name="protocols_p_service_e29d93_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="pricingcatalog",
            index=models.Index(
                ...
                name="protocols_p_valid_f_61a06e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="workordercounter",
            index=models.Index(
                fields=["year"], name="protocols_w_year_45c9a3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workorder",
            index=models.Index(
                fields=["order_number"], name="protocols_w_order_n_a1b2c3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workorder",
            index=models.Index(
                fields=["veterinarian", "-issue_date"],
                name="protocols_w_veterinary_d4e5f6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="workorder",
            index=models.Index(
                ...
                name="protocols_w_status_g7h8i9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="workorder",
            index=models.Index(
                fields=["-created_at"], name="protocols_w_created_j0k1l2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workorderservice",
            index=models.Index(
                fields=["work_order"], name="protocols_w_work_or_m3n4o5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="workorderservice",
            index=models.Index(
                fields=["protocol"], name="protocols_w_protoco_p6q7r8_idx"
            ),
        ),
    ]
