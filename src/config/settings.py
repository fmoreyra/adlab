...
ACCOUNT_LOGIN_REDIRECT_URL = "/users/complete-profile/"
ACCOUNT_LOGOUT_REDIRECT_URL = "/users/login/"
ACCOUNT_SIGNUP_REDIRECT_URL = "/users/complete-profile/"
...
# Google OAuth credentials (to be set via environment variables)
